...
export const Logo = () => (
<svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-a-b-2" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
